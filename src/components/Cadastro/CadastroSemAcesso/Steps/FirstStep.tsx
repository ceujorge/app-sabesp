    ...
    <View>
      ...
      <View style={styles.steps}>
        <View style={styles.halfView}>
          ...
          <Image style={styles.imgDocumento} source={require('../../../../../assets/icons/documento frente.jpeg')} />
        </View>
        <View style={styles.halfView}>
          <Text style={styles.cadastroTextoLeft}>Verso</Text>
          <Text style={styles.cadastroTextoLeft}>Carregar o arquivo</Text>
          <Image style={styles.imgDocumento} source={require('../../../../../assets/icons/documento verso.jpeg')} />
        </View>
      </View>
